...
using ServiceControl.Sessions;
using ServiceControl.Web.Models.Account;
using ServiceControl.Web.Views.Shared.Components.TenantChange;

namespace ServiceControl.Web.Controllers
{
    public class AccountController : ServiceControlControllerBase
    {
